...
class MessageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    Database.database().reference().child("USERS/\(conversationID)/").observe(.value, with: { snapshot in
        ...
        //load messages
        Constants.refs.databaseRoot.child("USERS/\(uidSelf!)/conversations/messageList/\(conversationID)/messages").queryOrdered(byChild:"timeStampPos").observe(.value, with:
            { snapshot in
    ...
    @IBAction func btnSendAction(_ sender: Any) {
                ...
                let senderMessage = ["sender_id": senderId, "name": senderDisplayName, "text": text, "dateTime":dateTime,"timeStampPos":timeStampPos] as [String : Any]
                ...
                let receiverMessage = ["sender_id": senderId, "name": senderDisplayName, "text": text, "dateTime":dateTime,"timeStampPos":timeStampPos] as [String : Any]
...
//move text field and send button when keyboard displays
